...
export class CanvasSidebar extends Component {
  ...
  render() {
    ...
    let rootIdentity = React.createElement(Link, {
            key: 1,
            to: "/~canvas/me", __self: this, __source: {fileName: _jsxFileName, lineNumber: 20}}
            , React.createElement('div', {
              className: 
                "w-100 pl4 pt1 pb1 f9 flex justify-start content-center " +
                selectedClass, __self: this, __source: {fileName: _jsxFileName, lineNumber: 23}}
              , React.createElement(Sigil, {
              ship: window.ship,
              color: "#000000",
              classes: "mix-blend-diff",
              size: 32, __self: this, __source: {fileName: _jsxFileName, lineNumber: 27}})
              , React.createElement('p', {
                className: "f9 w-70 dib v-mid ml2 nowrap mono"      ,
                style: {paddingTop: 6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 32}}
                , cite(window.ship)
              )
            )
          )
      ...
      canvasItems = Object.entries(props.canvasList).map((each, i) => {
        return (
          React.createElement(CanvasTitle, { key: i, id: each[0],
           ...
           location: each[1].metadata.location, __self: this, __source: {fileName: _jsxFileName, lineNumber: 45}} )
        )
      });
    }
    ...
    return (
      React.createElement('div', { className: "bn br-m br-xl b--gray4 b--gray2-d lh-copy h-100 " +
       "flex-shrink-0 pt3 pt0-m pt0-l pt0-xl relative overflow-y-hidden " +
        "dn-s flex-basis-100-s flex-basis-250-ns " + activeClasses, __self: this, __source: {fileName: _jsxFileName, lineNumber: 53}}
        ...
        , React.createElement('div', { className: "overflow-auto pb8 h-100 pr3"   , __self: this, __source: {fileName: _jsxFileName, lineNumber: 58}}
          , React.createElement(Link, { to: "/~canvas/new", className: "dib", __self: this, __source: {fileName: _jsxFileName, lineNumber: 59}}
            , React.createElement('p', { className: "green2 pa4 f9 dib"   , __self: this, __source: {fileName: _jsxFileName, lineNumber: 60}}, "New Canvas" )
          )
          , React.createElement(Link, { to: "/~canvas/join", className: "dib", __self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}
            , React.createElement('p', { className: "f9 gray2" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 63}}, "Join Canvas" )
          )
          , React.createElement('div', { className: "pt1", __self: this, __source: {fileName: _jsxFileName, lineNumber: 65}}
            , React.createElement('h2', { className: "f8 pr4 pb2 pl4 gray2 c-default"     , __self: this, __source: {fileName: _jsxFileName, lineNumber: 66}}, "Gallery")
            ,  canvasItems 
          )
        )
      )
